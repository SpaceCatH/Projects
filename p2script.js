...
function updateGamesPlayed() {
    var gamesWon = parseInt(document.getElementById("gamesWon").value) || 0;
    var gamesLost = parseInt(document.getElementById("gamesLost").value) || 0;


  

    gamesPlayed = gamesWon + gamesLost;
    document.getElementById("result").textContent = "Total games played: " + gamesPlayed;
}

// Event listener for the button
//document.getElementById("calculate").addEventListener("click", updateGamesPlayed);
